		...
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-pic js-tilt" data-tilt>
					<img src="images/dblogo.png" alt="IMG">
				</div>

				<form class="login100-form validate-form" method="post" action="LoginCheck">
					<span class="login100-form-title" style="color: #0C3CAE"> <b>LOGIN</b>
					</span>

					<div class="wrap-input100 validate-input"
						data-validate="Valid User ID is required: ex@abc.xyz">
						<input class="input100" type="text" name="User ID"
